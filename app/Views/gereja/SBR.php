        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item ">
                        <a class="nav-link <?= (request()->uri->getSegment(1) == 'homeSBR') ? 'active' : '' ?>" href="<?= base_url('homeSBR') ?>">HOME</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link <?= (request()->uri->getSegment(1) == 'agendaSBR') ? 'active' : '' ?>" href="<?= base_url('agendaSBR') ?>">PROGRAMASI</a>
                    </li>
                    <li class="nav-item ">
