...
<body>
    <div class="container mt-3">
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control" id="waktu_mulai" name="waktu_mulai" disabled value="<?= date('d-m-Y', strtotime($program['WAKTU_MULAI'])) ?>">
            </div>
        </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control" id="waktu_akhir" name="waktu_akhir" disabled value="<?= date('d-m-Y', strtotime($program['WAKTU_AKHIR'])) ?>">
            </div>
        </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control" id="swadaya" name="swadaya" disabled value="<?= $program['SWADAYA'] ?>">
            </div>
        </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control" id="dewan_paroki" name="dewan_paroki" disabled value="<?= $program['DEWAN_PAROKI'] ?>">
            </div>
        </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control" id="subsidi_kas" name="subsidi_kas" disabled value="<?= $program['SUBSIDI_KAS'] ?>">
            </div>
        </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-2">
                <input type="text" class="form-control" id="sumber_lain" name="sumber_lain" disabled value="<?= $program['SUMBER_LAIN'] ?>">
            </div>
        </div>
        ...
        <div class="form-group row mb-3">
            ...
            <div class="col-sm-6">
                <input type="text" class="form-control" id="status" name="status" disabled value="<?= $program['STATUS'] ?>">
            </div>
        </div>

        <form action="<?= base_url('monev/add/catatan/proses') ?>" method="POST">
            <input type="text" value="<?= $program['ID'] ?>" name="id_program" hidden>
